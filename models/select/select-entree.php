<?php
   ...
   if(isset($_GET['search']) && !empty($_GET['search'])){
        ...
        #L'affichage simple
        $_getData=$connexion->prepare("SELECT entree.id, `date`,typeproduit.description, catproduit.description, `quantite`, `prixAchat`, `boutique`, `photo` FROM `entree`, catproduit,boutique,typeproduit WHERE typeproduit.id=catproduit.typeproduit and catproduit.id=entree.Produit;");
        $_getData->execute();
